	...
	if (device === 'mobile') {
		return (
			<Stack className={'about-page'}>
				...
				<Stack className={'intro'}>
					<Stack className={'container'}>
						<Stack className={'left'}>
							...
							<p>
								We help people search, compare, and choose stays with clear pricing and verified listings worldwide.
							</p>
						</Stack>
						<Stack className={'right'}>
							<Box className="hero-image">
								<Box component="img" src="/img/banner/about-rabbit.png" alt="Relaxed dog in hotel-style robe" />
							</Box>
				...
				{/* WHAT MAKES US DIFFERENT – TRUST PILL STYLE */}
